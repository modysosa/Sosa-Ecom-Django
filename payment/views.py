...
def orders(request, pk):
    if request.user.is_authenticated and request.user.is_superuser:
        ...
        if 'shipped_dash' in referrer or 'not_shipped_dash' in referrer:
        ...
        if request.method == "POST":
            ...
            # Redirect to the previous page stored in the session
            previous_page = request.session.get('previous_page', 'home')
...
def proccess_order(request):
    if request.POST:
        ...
        # Get shipping session information
        ...
        # Create shipping address from shiping info
        ...
        if request.user.is_authenticated:
            ...
            #  get product info and may be it is maney product so i use for loop
...
def billing_info(request):
    if request.POST:
        ...
        # Create a session with shipping info for above function
